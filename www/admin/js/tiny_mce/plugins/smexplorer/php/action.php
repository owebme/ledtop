...
if (isset($_GET["action"])) {
	...
	if (strtolower($_POST["edit2"]) != ".php" && strtolower($_POST["edit2"]) != ".cgi" && strtolower($_POST["edit2"]) != ".pl" && strtolower($_POST["edit2"]) != ".pm" && strtolower($_POST["edit2"]) != ".js") {	
	...
	function _filetype($filename) {
		...
		if ($filetype == "php" or $filetype == "cgi" or $filetype == "pl" or $filetype == "pm" or $filetype == "js"){		
			return 1;
		}
	}
