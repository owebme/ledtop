$(document).ready(function(){
		...
		steps: [
			{
			  ...
			  intro: 'Список новостей сайта',
			  position: 'top'
			},
			{
			  element: 'div.three_pages ul li a.del',
			  intro: 'Удалить новость',
			  position: 'bottom'
			},
			{
			  element: 'div.three_pages ul li a.lamp',
			  intro: 'Сделать активным / не активным новость для отображения на сайте',
			  position: 'bottom'
			},
			{
			  element: 'div.three_pages ul li a.name',
			  intro: 'Наведите на название новости и вы увидите ее адрес, кликнув на нее вы перейдете к редактированию',
			  position: 'bottom'
			},			 
			{
	...
	$("a#help-tour").live('click', function(){
		if ($("div.three_pages").html() == ""){
			var el = $(this).parent();
			$(el).html('<div class="warning">'+$(el).html()+'<span>Добавьте хотя бы одну новость</span></div>');
